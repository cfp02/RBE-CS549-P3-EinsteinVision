...
% \begin{figure}
%     \centering
%     \includegraphics[width=0.8\textwidth]{images/YOLOPv2_output.png}
%     \caption{Output of YOLOPv2 \cite{YOLOPv2}.}
...
\begin{figure}
    ...
    %     \centering
    %     \includegraphics[width=\textwidth]{images/CLRNet_output.png}
    %     \caption{Output of CLRNet \cite{CLRNet} before preprocessing.}
...
% \begin{figure}
%     \centering
%     \includegraphics[width=0.5\textwidth]{images/reprojected_lane_lines.png}
...
%     \begin{subfigure}{0.45\textwidth}
%         \centering
%         \includegraphics[width=\textwidth]{images/3DBoxEstimation_output_trained.png}
%         \caption{Output of 3D Bounding Box Estimation Using Deep Learning and Geometry \cite{3DBoxEstimation} on training data.}
%         \label{fig:3DBoxEstimation_output_trained}
%     \end{subfigure}
%     \begin{subfigure}{0.45\textwidth}
%         \centering
%         \includegraphics[width=\textwidth]{images/3DBoxEstimation_output_test.png}
%         \caption{Output of 3D Bounding Box Estimation Using Deep Learning and Geometry \cite{3DBoxEstimation} on test data.}
